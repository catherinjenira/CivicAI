...
4. **Contextual Chat**: The app maintains chat history in the state and passes it to the Gemini model to allow follow-up questions and contextual learning.
5. **Quick Prompts**: Built-in prompts help users get started immediately with common questions like "How do I register to vote?" or "Explain the ballot counting process."
